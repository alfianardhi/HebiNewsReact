...
import {fetchBussinesDatas} from '../Redux/actions.js';
...
//let bussinesNewsDatas=[];

class BusinessNews extends React.Component{

  /*componentDidMount() {
    console.log("CEK ALFIAN");
      axios
        .get("https://newsapi.org/v2/top-headlines?country=id&category=business&apiKey=5b68d64f98c7483a8dcde98a42ba0494")
        .then(response => {
          
          bussinesNewsDatas = response.data.articles;
          console.log('hasil bussines var ------------- ', response.data);  
        });
  }*/
    componentDidMount() {
      this.props.fetchBussinesDatas();
    }
  ...
  return (
    ...
    <div className={classes.mainStyle}>
       <div style={{ marginTop: 20, padding: 30 }}>
        ...
        {this.props.bussinesNewsDatas.map(healthnews => (
...
const mapStateToProps = (state) => ({    
  bussinesNewsDatas:state.bussinesdata
});
...
export default connect(mapStateToProps,mapDispatchToProps) (withStyles(styles, { withTheme: true }) (BusinessNews));